...
public class Gauge extends View {
    ...
    private void applyAttrs(Context context, AttributeSet attrs) {
        ...
        faceColor = a.getColor(R.styleable.Gauge_faceColor, Color.YELLOW);
        rimColor = a.getColor(R.styleable.Gauge_rimColor, Color.YELLOW);
        scaleColor = a.getColor(R.styleable.Gauge_scaleColor, Color.YELLOW);
        needleColor = a.getColor(R.styleable.Gauge_needleColor, Color.YELLOW);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (needleShadow)
            needlePaint.setShadowLayer(canvasWidth / 123f, canvasWidth / 10000f, canvasWidth / 10000f, Color.BLACK);
