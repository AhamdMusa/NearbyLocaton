...
import com.example.nearbylocaton.Gauge.Gauge;
import com.example.nearbylocaton.Gauge.IGaugeNick;
import com.example.nearbylocaton.R;
import com.example.nearbylocaton.sensors.ILocationListener;
import com.example.nearbylocaton.sensors.LocationManager;
...
public class SpeedometerActivity extends AppCompatActivity implements ILocationListener {
...
//        chart.setPinchZoom(false);
        ...
        legend.setTextColor(getThemeColor(SpeedometerActivity.this, android.R.attr.textColor));
    ...
    private void updateUi(final float time, final Float speed, final Float energy, final Float acceleration) {
        ...
        SpeedometerActivity.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
    ...
    private void configureAxis(LineChart chart) {
        if (LineGraphs.ACCELERATION.dependency == YAxis.AxisDependency.RIGHT) {
            ...
            chart.getAxisLeft().setGridColor(getThemeColor(SpeedometerActivity.this, android.R.attr.textColor));
            chart.getAxisLeft().setTextColor(getThemeColor(SpeedometerActivity.this, android.R.attr.textColor));
            chart.getAxisLeft().setAxisLineColor(getThemeColor(SpeedometerActivity.this, android.R.attr.textColor));
            ...
            chart.getAxisRight().setGridColor(getThemeColor(SpeedometerActivity.this, android.R.attr.textColor));
            chart.getAxisRight().setTextColor(getThemeColor(SpeedometerActivity.this, android.R.attr.textColor));
            chart.getAxisRight().setAxisLineColor(getThemeColor(SpeedometerActivity.this, android.R.attr.textColor));
        }

        XAxis xAxis = chart.getXAxis();
        xAxis.setLabelRotationAngle(20f);
        xAxis.setTextColor(getThemeColor(SpeedometerActivity.this, android.R.attr.textColor));
        xAxis.setGridColor(getThemeColor(SpeedometerActivity.this, android.R.attr.textColor));
